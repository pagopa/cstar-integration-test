...
export function getHashedPan(baseUrl, params, { queryParams = undefined, version = undefined } = {}) {
    const queryString = queryParams ? '?' + queryParams.toString() : '';
    console.log(`${getBaseUrlWithVersion(baseUrl, version)}${queryString}/hashed-pans`);
    const res = http.get(`${getBaseUrlWithVersion(baseUrl, version)}${queryString}/hashed-pans`, params)
