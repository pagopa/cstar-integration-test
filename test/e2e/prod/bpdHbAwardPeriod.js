...
export default () => {
  ...
  group('GET Award Period', () => {
    ...
    group('Should get award periods V1', () => GetAwardPeriodSuccessV1(services.prod_issuer.baseUrl, params));
    group('Should get award periods V2', () => GetAwardPeriodSuccessV2(services.prod_issuer.baseUrl, params ));
