...
import { GetBpdTermsAndConditions } from '../../tests/bpdHbTermsAndConditions.js';
...
export default () => {
  ...
  group('GET Award Period', () => {
    ...
    group('Should get FA terms and condiitons', () => GetBpdTermsAndConditions(services.dev_issuer.baseUrl, params));
