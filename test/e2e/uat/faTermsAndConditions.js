...
export default () => {
  ...
  group('GET Award Period', () => {
    ...
    group('Should get BPD T&C via Blob Get', () => GetFaTermsAndConditionsViaBlob(services.uat_issuer.baseUrl, params));
    group('Should get BPD T&C via dedicated API', () => GetFaTermsAndConditions(services.uat_issuer.baseUrl, params));
